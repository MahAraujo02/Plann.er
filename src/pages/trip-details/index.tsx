...
export function TripDatailsPage () {
    ...
    return (
        <div className="max-w-6xl px-6 py-10 mx-auto space-y-8">
            ...
            <main className="flex gap-16">
                <div className="flex-1 space-y-8">
                    <div className="flex items-center justify-between">
                        ...
                        <button onClick={openCreateActivyModal} className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400">
                            Cadastrar Atividade
           ...
           < CreateActivityModal
            closeCreateActivyModal={closeCreateActivyModal}/>
           )}
